...
<div class="card border  mb-4 p-3">
    <div class="s-body text-center mt-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <p class=" text-success">{{ Auth::user()->designation }}</p>
        </div>
...
<div class="card  border mb-4 mb-lg-0">
    <div class="card-body p-0">
        <ul class="list-group list-group-flush ">
            <li class=" list-group-item-success list-group-item   d-flex align-items-center p-3">
                <a href="{{ route('account.profile') }}" class="d-flex textU align-items-center">
            ...
            <li class="list-group-item d-flex list-group-item-success align-items-center p-3">
                <a href="{{ route('account.createJob') }}" class="d-flex textU align-items-center">
                    ...
                    <span class="ms-2">Publier une offre</span>
                </a>
            </li>
            <li class="list-group-item d-flex list-group-item-success align-items-center p-3">
                <a href="{{ route('account.myJobs') }}" class="d-flex textU align-items-center">
                    ...
                    <span class="ms-2">Mes offres</span>
                </a>
            </li>
            <li class="list-group-item d-flex list-group-item-success align-items-center p-3">
                <a href="{{ route('account.myJobApplications') }}" class="d-flex textU align-items-center">
                    ...
                    <span class="ms-2">Candidatures </span>
                </a>
            </li>
            <li class="list-group-item d-flex list-group-item-success align-items-center p-3">
                <a href="{{ route('account.savedJobs') }}" class="d-flex textU align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-fill" viewBox="0 0 16 16">
                        <path d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2"/>
                      </svg>
                    <span class="ms-2">Offres sauvegardees</span>
                </a>
            </li>
